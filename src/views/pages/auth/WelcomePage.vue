<template>
  <ion-page class="ion-page">
    ...
    <ion-content>
      <ion-slides ref="slider" :pager="true" class="h-full welcome-slider" @ionSlideTransitionStart="slideChange"
                  mode="ios">
        <ion-slide>
          <img src="@/assets/img/welcome/welcome-1.png"/>
        </ion-slide>
        <ion-slide>
          <img src="@/assets/img/welcome/welcome-2.png"/>
        </ion-slide>
        <ion-slide>
          <img src="@/assets/img/welcome/welcome-3.png"/>
        </ion-slide>
      </ion-slides>
    </ion-content>
  </ion-page>
