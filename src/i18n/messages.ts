export const messages = {
  en: {
    ...
    'cleanup-type-selection': '¿You have already done the cleanup or do you want some help?',
    'cleanup-type-selection-done': 'Is done',
    'cleanup-type-selection-not-done': 'I want help' ,
  ...
  es: {
    ...
    'cleanup-type-selection': '¿Ya has hecho la recogida o quieres que te echen una mano para hacerla?',
    'cleanup-type-selection-done': 'Ya está hecha',
    'cleanup-type-selection-not-done': 'Quiero ayuda',
