...
export default {
    en: {...auth.en, ...cleanups.en, ...common.en, ...errors.en, ...user.en, ...events.en, ...community.en, ...alerts.en, ...settings.en, ...stats.en},
    es: {...auth.es, ...cleanups.es, ...common.es, ...errors.es, ...user.es, ...events.es, ...community.es, ...alerts.es, ...settings.es, ...stats.es}
}
